...
require 'config.php';
require 'header.php';
$name=$description=$uploadFile=$staff_id= '';
$name_err=$description_err=$uploadFile_err=$tutor_id_err= '';


//grab supplier id
if(isset($_SESSION['kipande'])){
    $staff_id =$_SESSION['kipande'];
}

if(isset($_POST['btn_addStaff']) and isset($_FILES['uploadFile'])){
//    grab form data
    $title= $_POST['title'];
    $price= $_POST['price'];
...
//   validate data
    ...
    if(!isset($desciption)){
        $desciption_err = "Please fill this field";
    }
//    process file data
        ...
        <div class="col-md-4 col-lg-4 col-xl-4">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>" method="post" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="form-group">
                        <textarea name="desciption" class="forn-control" cols="30" rows="10"></textarea>
                    </div>
                    <input type="file" name="uploadFile">
                    <button class="btn btn-warning btn-block" name="btn_addStaff">Add Staff</button>
                </fieldset>
            </form>
        </div>
    </div>
