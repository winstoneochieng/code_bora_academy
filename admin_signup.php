...
//    results from db
        ...
        $sql = "INSERT INTO `admins`(`id`, `username`, `email`, `password`, `user_type`) VALUES (NULL,'$username','$email','$password','$user_type')";
                ...
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>" method="post">
                    <fieldset>
                        ...
                        <div class="input-group">
                             <span>
                                 Admins Support <input type="radio" name="user-type" value="admin">
                             </span>
                            <span>
                                 Tutor <input type="radio" checked name="user-type" value="student">
                             </span>
                        </div>
                        <button class="btn btn-warning btn-block" name="btn_signup">Signup</button>
                        <br> <br>
