                ...
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>" method="post">
                    <fieldset>
                        <div class="input-group">
                             <span>
                                 Admin <input type="radio" name="user-type" value="admin">
                             </span>
                            <span>
                                 Student <input type="radio" checked name="user-type" value="student">
                             </span>
                        </div>
                        <br>
                        ...
                        <button class="btn btn-warning btn-block" name="btn_signup">REGISTER</button>
                    </fieldset>
                </form>
            </div>
        </div>
